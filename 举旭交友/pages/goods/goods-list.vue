<template>
	<view>
		...
		<view class="success-cont flex flex-direction align-center justify-center">
	...
	export default {
		...
		onReachBottom(){
			...
			for(let i=1;i<=10;i++){
				...
				let p = { goods_id: goods_id, img: '../../static/img/goods/p'+(goods_id%10==0?10:goods_id%10)+'.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '杭州市', slogan:'￥45元/人' };
